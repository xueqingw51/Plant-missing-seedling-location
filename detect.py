...
from utils.utils import plot_dots_on_cotton, distancing
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        if label is not None:
                            if (label.split())[0] == 'cotton':
                                cotton_coords.append(xyxy)
                                plot_one_box(xyxy, im0, line_thickness=3)
                                # plot_dots_on_cotton(xyxy, im0)


                # Plot lines connecting people
                distancing(cotton_coords, im0, dist_thres_lim=(200, 250))
